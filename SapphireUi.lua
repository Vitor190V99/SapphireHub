...
local RedTheme = {
    ...
    Background = Color3.fromRGB(25, 0, 0),       -- Very dark red
    Element = Color3.fromRGB(55, 10, 10),        -- Slightly brighter red
    ElementBorder = Color3.fromRGB(100, 20, 20), -- Red border
    Text = Color3.fromRGB(20, 20, 20),           -- Dark letters
    SubText = Color3.fromRGB(60, 60, 60),        -- Slightly lighter text
}
...
toggleBtn.AnchorPoint = Vector2.new(1, 0)        -- top-right corner
toggleBtn.Position    = UDim2.new(1, -10, 0, 10) -- 10px inset
toggleBtn.Size        = UDim2.new(0, 32, 0, 32)  -- 32×32px
toggleBtn.BackgroundTransparency = 1
toggleBtn.Image       = "rbxassetid://112681899122100"  -- replace with your asset
toggleBtn.ZIndex      = 10
...
toggleBtn.MouseButton1Click:Connect(function()
    ...
    toggleBtn.Rotation = uiVisible and 0 or 180
end)
