if (game:GetService("CoreGui")):FindFirstChild("SapphireHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).SapphireHub:Destroy();
...
ImageButton.Image = "rbxassetid://112681899122100";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("SapphireHub")).Enabled = not (game.CoreGui:FindFirstChild("SapphireHub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Sapphire Hub") then
			makefolder("Sapphire Hub");
		end;
		if not isfolder("Sapphire Hub/Library/") then
			makefolder("Sapphire Hub/Library/");
		end;
		if not isfile(("Sapphire Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Sapphire Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Sapphire Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Sapphire Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Sapphire Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	SapphireHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = SapphireHub;
	...
	CreateButton("Reset Config", function()
		if isfolder("Sapphire Hub") then
			delfolder("Sapphire Hub");
		end;
